/**
 * SoulGoldHero — Solid obsidian editorial hero (no background image).
 * Text stagger + magnetic CTA only — GPU-safe transform / opacity.
 */
'use client';
  ...
  return (
    ...
    >
      <div className="relative z-10 h-full flex flex-col items-center justify-center px-5 text-center">
        <p
          className="sg-eyebrow mb-5 text-[#C9A03D]/80 uppercase tracking-[0.32em] text-xs font-medium"
        ...
        <h1
          className="text-[#FEF7ED] mb-5 leading-[1.1]"
          style={{
        ...
        <p
          className="sg-sub-text text-[#FEF7ED]/75 max-w-[520px] mb-10 leading-[1.6]"
          style={{
