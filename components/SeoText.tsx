...
export default function SeoText({ lang }: { lang: Lang }) {
  ...
  if (rtl) {
    return (
      <FadeInSection as="section" className="py-10 px-4 max-w-[1400px] mx-auto">
        ...
        <div className="w-16 h-0.5 bg-[#2d6a4f] mb-5" />

        <p className="premium-heading font-bold text-[#1a3c34] text-sm tracking-tight mb-3">
          أفضل مورد للفواكه والخضروات والمستلزمات الغذائية في جدة
        </p>

        <div className="text-gray-700 text-sm leading-relaxed space-y-4">
          <p>
            <span className="text-[#2d6a4f] font-medium">Soul Gold Trading — صول الذهبية للتجارة</span>{' '}
        ...
        <a
          ...
          className="mt-6 inline-flex items-center gap-2 premium-ease premium-btn-hover bg-[#1a3c34] text-white text-sm font-bold px-6 py-3 rounded-full hover:bg-[#2d6a4f]"
        >
          تواصل عبر واتساب
  ...
  return (
    <FadeInSection as="section" className="py-10 px-4 max-w-[1400px] mx-auto">
      ...
      <div className="text-gray-700 text-sm leading-relaxed space-y-4">
        <p>
          <span className="text-[#2d6a4f] font-medium">Soul Gold Trading</span> is a Saudi{' '}
